...
<!-- 
https://researchportal.hw.ac.uk/en/persons/ahmed-h-elsheikh/publications/ -->
<!-- {% include gallery caption="." class="full" %}
 -->
...
### Education
- PhD, June 2007, Applied Computational Science and Engineering, McMaster University,
Ontario, Canada.
- MAsc, June 2002, Structural and Earthquake Engineering, McMaster University,
...
- Alhasan Abdellatif, Geological and environmental data generation using Generative Adversarial Networks, June 2023.
- Ang Chin Tee, Seismic interpretation using Deep Neural Network with Geological Constraints, Exp. December 2024.
- Ahmad Sharif A Rahman, Deep learning based super resolution for seismic data reconstruction, Exp. December 2024. -->
